...
const nextBelts = document.querySelectorAll('.next-icon') ;
const prevBelts = document.querySelectorAll('.prev-icon') ;
let index = 0;
...
for(let i  = 0 ; i< nextBelts.length; i++)
{
    nextBelts[i].addEventListener('click', showNextBelt)
}    
...
for(let i  = 0 ; i< prevBelts.length; i++)
{
    prevBelts[i].addEventListener('click', showPrevBelt);
}   
